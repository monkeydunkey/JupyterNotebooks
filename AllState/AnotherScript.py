...
if __name__ == "__main__":
    ...
    for column in list(train.select_dtypes(include=['object']).columns):
        if train[column].nunique() != test[column].nunique():
            ...
            temp = train_test.groupby(column).count()['id']
            mapObj = {}
            ...
            train_test[column] = train_test[column].map(mapObj)
    ...
    for i, (train_index, test_index) in enumerate(kf):
        ...
        clf = models ## Should be changed to i
    ...
    ## TODO:Try getting the best combination possible by using a hold-out validation set
    mpred = pred / n_folds
    ...
    sub_file = 'submission_5fold-average-lightGBM_' + str(score) + '_' + str(
